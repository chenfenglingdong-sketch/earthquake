...
define(['./Draw'],
    ...
    var USGS = function (wwd, control) {
        ...
        var minDateISO = new Date(currentTimeUTC + -20 * 24 * 60 * 60 * 1000).toISOString().split(/[-]+/);
        ...
        this.getUrl = function (drawingType) {
            ...
            var resourcesUrl = "serv/getEarthquakes.php"; // 指向PHP脚本
